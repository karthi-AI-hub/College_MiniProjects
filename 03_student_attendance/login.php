...
<head>
    ...
    <style>
        body {
            background-color: #fff3cd; /* Light warning/orange background */
            display: flex;
            align-items: center;
        ...
        .login-card {
            ...
            background: #fff;
            border-top: 5px solid #ffc107; /* Orange top border */
        }
    </style>
</head>
<body>
...
<div class="login-card">
    <h3 class="text-center mb-4 text-warning fw-bold" style="color: #fd7e14 !important;">Staff Login</h3>
    <?php if($error): ?>
