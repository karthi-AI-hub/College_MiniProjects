        ...
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="view_employees.php" class="list-group-item list-group-item-action <?php echo (in_array(basename($_SERVER['PHP_SELF']), ['view_employees.php', 'add_employee.php', 'edit.php'])) ? 'active' : ''; ?>">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-dark mb-4">
                <div class="container-fluid">
                    <button class="btn btn-purple me-3" id="menu-toggle"><i class="fas fa-bars"></i></button>
                    <span class="navbar-brand d-none d-lg-block">Employee Management</span>
                    
                    <div class="ms-auto d-flex align-items-center">
                        <span class="text-muted me-3">Welcome, <strong class="text-white">Admin</strong></span>
                        <div class="flex-shrink-0 dropdown">
                            <a href="#" class="d-block link-light text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="https://ui-avatars.com/api/?name=Admin&background=4f46e5&color=fff" alt="mdo" width="32" height="32" class="rounded-circle">
                            </a>
